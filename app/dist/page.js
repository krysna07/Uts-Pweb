    ...
    return (React.createElement("div", { className: "flex flex-col items-center px-4 sm:px-6 lg:px-8" },
        ...
        React.createElement("section", { className: "w-full max-w-6xl mx-auto py-20 border-t border-slate-100 dark:border-slate-800" },
            ...
            React.createElement("div", { className: "flex flex-col md:flex-row gap-8 max-w-4xl mx-auto" },
                React.createElement(TeamCard_1["default"], { name: "I Gusti Krysna DevaNanda", role: "UI/UX & Desain", image: "/foto%20krysna.jpeg", description: "Masih belajar merancang tampilan yang nyaman dipakai. Suka ngulik desain dan mencoba membuat sesuatu yang enak dilihat, meskipun masih banyak yang perlu dipelajari.", skills: ["Figma", "Tailwind CSS", "HTML/CSS", "Canva"] }),
                React.createElement(TeamCard_1["default"], { name: "Gede Krisna Chita Dharma Wacika", role: "Logika & Pengembangan", image: "/foto%20dekrisna.jpeg", description: "Masih dalam proses memahami logika pemrograman dan cara kerja web. Senang mencoba hal baru meski kadang error-nya lebih banyak dari yang diharapkan.", skills: ["Next.js", "JavaScript", "React", "TypeScript"] })))));
}
